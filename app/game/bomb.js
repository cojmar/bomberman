...
export class Bomb extends GameObject {
    ...
    create() {
        ...
        this.text = this.scene.add.text(this.x, this.y, '5', { font: '17px Roboto Mono', fill: '#010e1b', fontStyle: 'bold', align: 'center', strokeThickness: 3, stroke: '#ffffff' }).setOrigin(0.5, 0.5)
